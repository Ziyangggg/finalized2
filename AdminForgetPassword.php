...
if(isset($_POST["sendforget"])){
    ...
    $query = "SELECT * FROM admin_info where AdminEmail = '$email' ";
    ...
    if($res>0)
    {
        ...
        <br>
        <p><a href="http://localhost/finalized2/AdminResetPassword.php?secret='.base64_encode($email).'">Reset Password</a></p>
